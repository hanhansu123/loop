...
;(function($,window,document,undefined){
   //默认参数var this.PARAMS;
            var plugin=function(ele, opt){
						this.parent=ele;
						this.defaults= {percent:100 ,w:200,oneCircle:"false"};	
						//初始化参数
				      ...
				      DrawCircle:function(){
					       ...
					       if(!canvasSupport()){
							...
							function drawScreen(){
								...
								//cxt.fillText(mess,canvas.width/2,canvas.height);
								cxt.fillText(mess,40,30);
							}	
						  //
